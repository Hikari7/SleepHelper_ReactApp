...
function Header() {
  return (
    <>
      <nav className="px-7 sm:px-4 py-5 rounded bg-transparent z-10 relative">
        <div className="container flex justify-between items-center mx-auto text-white">
          <div>
            <Link to="/">
              <a className="self-center text-xl whitespace-nowrap font-light cursor-pointer transition hover:duration-700 text-white  opacity-20 hover:opacity-80">
                Sleep tight
              </a>
            </Link>
          </div>
          <div className="flex">
            ...
            <svg
              ...
              height="16"
              fill="currentColor"
              class="bi bi-lamp cursor-pointer mr-4 transition duration-0 hover:duration-700 opacity-20 hover:opacity-80"
              viewBox="0 0 16 16"
            >
              <path
                fill-rule="evenodd"
